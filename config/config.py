...
class PathsConfig(BaseSettings):
    ...
    cleaned_html_data: Path = Field(
        default=Path("output_data/consolidated/unique_raw_html_data")
    )
    manual_cleaned_html_data: Path = Field(
        default=Path("output_data/manual_cleaned_html_data")
    )
...
class DatabaseConfig(BaseSettings):
    consolidated_html_db: Path = Field(
        default=Path("output_data/consolidated/consolidated_html_data.db")
    )
